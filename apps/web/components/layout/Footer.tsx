...
export default function Footer() {
  return (
    <footer className="w-full backdrop-blur-sm text-muted-foreground border-t border-border/50">
      <div className="container">
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          {/* Logo and Bio Section */}
          <div className="col-span-2 lg:col-span-2 space-y-6">
            <Link href="/" className="text-3xl font-bold text-foreground tracking-tighter">
              V
            </Link>
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-muted/50 border border-border text-[10px] font-medium tracking-wide text-foreground/80">
          ...
          {footerLinks.map((column) => (
            <div key={column.title} className="col-span-1 space-y-6">
              <h3 className="text-foreground font-semibold text-sm tracking-wide">{column.title}</h3>
